...
export const Icons = {
    ...
    Diagnostics: ({ className = "w-4 h-4", strokeWidth = 2 }: IconProps) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    Back: ({ className = "w-4 h-4", strokeWidth = 3 }: IconProps) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M15 19l-7-7 7-7" />
        </svg>
    ),
    Alert: ({ className = "w-8 h-8", strokeWidth = 2 }: IconProps) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    Copy: ({ className = "w-5 h-5", strokeWidth = 2.5 }: IconProps) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
