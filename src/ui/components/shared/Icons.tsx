...
export const Icons = {
    Close: ({ className = ICON_DEFAULTS.CLOSE.className, strokeWidth = ICON_DEFAULTS.CLOSE.strokeWidth }: IconProps): React.ReactElement => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M6 18L18 6M6 6l12 12" />
        </svg>
    ),
    Reset: ({ className = ICON_DEFAULTS.RESET.className, strokeWidth = ICON_DEFAULTS.RESET.strokeWidth }: IconProps): React.ReactElement => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    Diagnostics: ({ className = ICON_DEFAULTS.DIAGNOSTICS.className, strokeWidth = ICON_DEFAULTS.DIAGNOSTICS.strokeWidth }: IconProps): React.ReactElement => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    Back: ({ className = ICON_DEFAULTS.BACK.className, strokeWidth = ICON_DEFAULTS.BACK.strokeWidth }: IconProps): React.ReactElement => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M15 19l-7-7 7-7" />
        </svg>
    ),
    Alert: ({ className = ICON_DEFAULTS.ALERT.className, strokeWidth = ICON_DEFAULTS.ALERT.strokeWidth }: IconProps): React.ReactElement => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    Copy: ({ className = ICON_DEFAULTS.COPY.className, strokeWidth = ICON_DEFAULTS.COPY.strokeWidth }: IconProps): React.ReactElement => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
