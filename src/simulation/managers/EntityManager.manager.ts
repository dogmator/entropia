...
import type { GridManager } from './GridManager.manager';

export class EntityManager {
  public readonly organisms = new Map<string, Organism>();
  public readonly food = new Map<string, Food>();
  public readonly obstacles = new Map<string, Obstacle>();
