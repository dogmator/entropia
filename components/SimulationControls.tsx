...
const SimulationControls: React.FC<SimulationControlsProps> = ({
  ...
  // Визначити колір і статус на основі швидкості
  ...
  // Швидкі кнопки для популярних значень
  const quickButtons = [
  ...
  return (
    <div className="flex flex-col gap-4 bg-white/5 p-4 rounded-xl border border-white/5">
      {/* Заголовок з індикатором статусу */}
        ...
        <div className="grid grid-cols-5 gap-2">
          {quickButtons.map((btn) => (
            <button
              ...
              className={`h-8 rounded-lg text-[10px] font-bold transition-all duration-200 touch-manipulation ${
                speed === btn.value
